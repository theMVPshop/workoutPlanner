...
export const prompt = async (name, age, gender, fitnessLevel, workoutType, muscleGroup, days, startTime, endTime) => {
  const chatCompletion = await openai.chat.completions.create({
    messages: [
      ...
      { role: 'user', content: `My name is ${name}. I am ${age} years old. I am a ${gender}. I prefer ${workoutType} workouts. I am able to go to the gym on ${days} from ${startTime} to ${endTime}. My goal is to target my ${muscleGroup}. I am at a ${fitnessLevel} fitness level.` }
    ],
    model: 'gpt-3.5-turbo',
  });
